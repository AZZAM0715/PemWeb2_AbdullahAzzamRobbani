        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="card card-info">
                    ...
                    <!-- /.card-header -->
                    <!-- form start -->
                    <form method="post" action="Project_bmi.php" class="form-horizontal">
            ...
            $pasien_hardcode = ['kodePasien' => 'FX-PAS-001', 'tanggal' => '16-04-2022', 'nama' => 'cecep', 'jk' => 'Laki-laki', 'bb' => 90, 'tb' => 175, 'bmi' => 21.75, 'status' => 'Kelebihan Berat Badan', 'image' => 'kurus'];
